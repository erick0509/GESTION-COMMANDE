...
<html>
    <head>
        <title>chercher les commandes effectues par un client</title>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8 corps">
                    ...
                    <aside class="table-responsive">
                        <div class="row">
                            <form class="form-horizontal col-md-offset-3 col-md-6" method="GET" action="../REQUETTES/chercher_commande_client.php">
                                <div class="form-group">
                                    <legend>Chercher les commandes effectues par un client</legend>
                                </div>
                                <div class="row">
                                    <div class="form-group has-feedback">
                                        <div class="col-md-offset-1 col-md-10">
                                            <input type="text" name="id" class="form-control" placeholder="id client">
                        ...
                        <div class="row">
                            <?php 
                                if(isset($_GET['id_valid'])){
                                        ...
                                        $lgcommande= $xpath->query("//commande[@no_client=$i]/ligne_commande");// utilisation de Xpath
