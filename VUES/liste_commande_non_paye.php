...
<html>
    <head>
        <title>liste des commandes non payes</title>
                ...
                <div class="col-md-offset-2 col-md-8 corps">
                    ...
                    <aside class="table-responsive">
                            <?php 
                                        ...
                                        $lgcommande= $xpath->query("//ligne_commande[paye='Non']");// utilisation de Xpath
                                        if($lgcommande->length==0){
                                            echo "<h4 style='color:red;'>tout les commandes sont deja payes</h4>";
                                        }
                                        else{
                                            ?>
                                            <table class="table table-bordered table-striped ">
                                                <caption>
                                                    <h4>liste des commandes non payes</h4>
                                                </caption>
                                                <thead>
                                                    <tr>                       
                                                        <th>id.Client</th>
